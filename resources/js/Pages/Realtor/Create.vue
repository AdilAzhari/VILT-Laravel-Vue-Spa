<template>
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div class="mb-12 md:mb-16 text-center">
            <div class="inline-flex items-center justify-center w-14 h-14 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full mb-6 shadow-lg">
            ...
            <p class="text-neutral-600 dark:text-neutral-400 text-lg md:text-xl leading-relaxed">
                Transform your property into an irresistible opportunity
            </p>
        </div>

        <div class="bg-white dark:bg-neutral-800 rounded-3xl shadow-2xl border border-neutral-200 dark:border-neutral-700 p-8 md:p-12">
            <form @submit.prevent="create">
                <div class="mb-12">
                    <div class="flex items-center gap-4 mb-8">
                        <div class="w-10 h-10 border-2 border-emerald-500 rounded-xl flex items-center justify-center text-emerald-600 dark:text-emerald-400">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z"/>
                            </svg>
                        </div>
                        <h2 class="text-3xl font-serif font-bold text-neutral-800 dark:text-neutral-100">Property Details</h2>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div>
                            <label for="beds" class="flex items-center gap-2 mb-3 text-sm font-semibold text-neutral-700 dark:text-neutral-300">
                            ...
                            <div class="relative">
                                <input
                                    ...
                                    min="0"
                                />
                                <div class="absolute inset-y-0 right-5 flex items-center text-neutral-400 pointer-events-none">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z"/>
                                    </svg>
                                </div>
                        ...
                        <div>
                            <label for="baths" class="flex items-center gap-2 mb-3 text-sm font-semibold text-neutral-700 dark:text-neutral-300">
                        ...
                        <div>
                            <label for="area" class="flex items-center gap-2 mb-3 text-sm font-semibold text-neutral-700 dark:text-neutral-300">
                            ...
                            <div class="relative">
                                ...
                                />
                                <div class="absolute inset-y-0 right-5 flex items-center text-neutral-400 pointer-events-none">
                                    <span class="text-sm font-medium">ft²</span>
                                </div>
                            </div>
                ...
                <div class="mb-12">
                    <div class="flex items-center gap-4 mb-8">
                        <div class="w-10 h-10 border-2 border-violet-500 rounded-xl flex items-center justify-center text-violet-600 dark:text-violet-400">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                            </svg>
                        </div>
                        <h2 class="text-3xl font-serif font-bold text-neutral-800 dark:text-neutral-100">Location Details</h2>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            <label for="city" class="flex items-center gap-2 mb-3 text-sm font-semibold text-neutral-700 dark:text-neutral-300">
                        ...
                        <div>
                            <label for="code" class="flex items-center gap-2 mb-3 text-sm font-semibold text-neutral-700 dark:text-neutral-300">
                        ...
                        <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div class="md:col-span-2">
                                <label for="street" class="flex items-center gap-2 mb-3 text-sm font-semibold text-neutral-700 dark:text-neutral-300">
                            ...
                            <div class="md:col-span-1">
                                <label for="street_nr" class="flex items-center gap-2 mb-3 text-sm font-semibold text-neutral-700 dark:text-neutral-300">
                ...
                <div class="mb-12">
                    <div class="flex items-center gap-4 mb-8">
                        <div class="w-10 h-10 border-2 border-green-500 rounded-xl flex items-center justify-center text-green-600 dark:text-green-400">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"/>
                            </svg>
                        </div>
                        <h2 class="text-3xl font-serif font-bold text-neutral-800 dark:text-neutral-100">Pricing</h2>
                    </div>

                    <div class="max-w-lg">
                        <label for="price" class="flex items-center gap-2 mb-3 text-sm font-semibold text-neutral-700 dark:text-neutral-300">
                ...
                <div class="flex justify-center pt-6">
                    ...
                    >
                        <svg v-if="!form.processing" class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
// Set layout manually (this works with Inertia's layout system)
defineOptions({ layout: MainLayout })
</script>

<style scoped>
/* Common button styles from the reference */
